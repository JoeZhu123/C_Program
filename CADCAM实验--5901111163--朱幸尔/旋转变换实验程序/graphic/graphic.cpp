...
CGraphicModule _Module;

BEGIN_OBJECT_MAP(ObjectMap)
END_OBJECT_MAP()

LONG CGraphicModule::Unlock()
{
	AfxOleUnlockApp();
	return 0;
}

LONG CGraphicModule::Lock()
{
	AfxOleLockApp();
	return 1;
}
LPCTSTR CGraphicModule::FindOneOf(LPCTSTR p1, LPCTSTR p2)
{
	while (*p1 != NULL)
	{
		LPCTSTR p = p2;
...
BOOL CGraphicApp::InitATL()
{
	...
	while (lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_GRAPHIC, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_GRAPHIC, TRUE);
